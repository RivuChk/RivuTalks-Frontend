(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    ...
    if (typeof this['react-dom/client'] === 'undefined') {
      throw new Error("Error loading module 'rivu-talks-frontend'. Its dependency 'react-dom/client' was not found. Please, check whether 'react-dom/client' is loaded prior to 'rivu-talks-frontend'.");
    }
    if (typeof react === 'undefined') {
      throw new Error("Error loading module 'rivu-talks-frontend'. Its dependency 'react' was not found. Please, check whether 'react' is loaded prior to 'rivu-talks-frontend'.");
    }
    if (typeof this['@emotion/css'] === 'undefined') {
      throw new Error("Error loading module 'rivu-talks-frontend'. Its dependency '@emotion/css' was not found. Please, check whether '@emotion/css' is loaded prior to 'rivu-talks-frontend'.");
    }
    if (typeof this['kotlin-kotlin-stdlib-js-ir'] === 'undefined') {
      throw new Error("Error loading module 'rivu-talks-frontend'. Its dependency 'kotlin-kotlin-stdlib-js-ir' was not found. Please, check whether 'kotlin-kotlin-stdlib-js-ir' is loaded prior to 'rivu-talks-frontend'.");
    }
    if (typeof this['kotlin-wrappers-kotlin-react-js-ir'] === 'undefined') {
      throw new Error("Error loading module 'rivu-talks-frontend'. Its dependency 'kotlin-wrappers-kotlin-react-js-ir' was not found. Please, check whether 'kotlin-wrappers-kotlin-react-js-ir' is loaded prior to 'rivu-talks-frontend'.");
    }
    if (typeof this['kotlin-wrappers-kotlin-react-dom-js-ir'] === 'undefined') {
      throw new Error("Error loading module 'rivu-talks-frontend'. Its dependency 'kotlin-wrappers-kotlin-react-dom-js-ir' was not found. Please, check whether 'kotlin-wrappers-kotlin-react-dom-js-ir' is loaded prior to 'rivu-talks-frontend'.");
    }
    root['rivu-talks-frontend'] = factory(typeof this['rivu-talks-frontend'] === 'undefined' ? {} : this['rivu-talks-frontend'], this['react-dom/client'], react, this['@emotion/css'], this['kotlin-kotlin-stdlib-js-ir'], this['kotlin-wrappers-kotlin-react-js-ir'], this['kotlin-wrappers-kotlin-react-dom-js-ir']);
  }
  ...
  setMetadataFor(Singleton, 'Singleton', objectMeta, undefined, undefined, undefined, undefined, []);
  //endregion
  function Singleton() {
    Singleton_instance = this;
    this.Prefix_1 = 'something';
  }
  Singleton.prototype.get_Prefix_31t2nv_k$ = function () {
  ...
  function main$lambda($this$create) {
    $this$create.name = Singleton_getInstance().get_Prefix_31t2nv_k$() + ' Kotlin/JS';
  ...
  function Welcome$lambda($this$FC, props) {
    ...
    tmp$ret$3 = tmp$ret$2;
    var tmp = tmp$ret$3;
    $this$FC.invoke_hixay3_k$(tmp, Welcome$lambda$lambda(name$delegate));
    var tmp$ret$7;
    ...
    tmp$ret$7 = tmp$ret$6;
    var tmp_0 = tmp$ret$7;
    $this$FC.invoke_hixay3_k$(tmp_0, Welcome$lambda$lambda_0(name$delegate));
    return Unit_getInstance();
  }
...
//# sourceMappingURL=rivu-talks-frontend.js.map
